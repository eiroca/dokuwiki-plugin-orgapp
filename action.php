...
class action_plugin_orgapp extends DokuWiki_Action_Plugin {
  ...
  function toolbar_add_button_orgapp(&$event, $param) {
    $event->data[] = array (
        'type' => 'format', 'title' => $this->getLang('orgapp_editor'), 'icon' => '../../plugins/orgapp/editor/orgapp.png', 'open' => '<orgapp', 'sample' => @file_get_contents(DOKU_PLUGIN_ORGAPP . 'editor/sample.txt'), 'close' => '</orgapp>'
    );
  }
